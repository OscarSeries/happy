/**
 * English translations for the Jappy app
 * Values can be:
...
export const en = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Jappy Coder is a Codex and Claude Code mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'You\'ve reached the maximum number of voice conversations this month. We may add on-demand voice usage in the future — please file an issue at github.com/juitem/jappy/issues if you hit this limit.',
    ...
    server: {
        ...
        notValidHappyServer: 'Not a valid Jappy Server',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Jappy Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy Jappy Session ID',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Install the Jappy CLI',
            runIt: 'Run it',
    ...
    settingsVoice: {
        ...
        byoDescription: 'Use your own ElevenLabs agent instead of the Jappy default. No subscription required — connect directly with your own ElevenLabs account. Your agent must define two client tools: messageClaudeCode (sends text to the coding agent) and processPermissionRequest (allows or denies tool use). It receives session context via the {{initialConversationContext}} dynamic variable.',
        customAgentId: 'ElevenLabs Agent ID',
        customAgentIdNotSet: 'Not configured',
        customAgentIdDescription: 'Enter your ElevenLabs agent ID. Leave empty to use the Jappy default.',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: 'Direct Connection',
        bypassTokenSubtitle: 'Skip Jappy server, connect straight to ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Jappy Coder account. This will allow the terminal to send and receive messages securely.',
