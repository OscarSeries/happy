/**
 * Chinese (Traditional) translations for the Jappy app
 * Values can be:
...
export const zhHant: TranslationStructure = {
    ...
    settings: {
        ...
        about: '關於',
        aboutFooter: 'Jappy Coder 是一個 Codex 和 Claude Code 行動用戶端。它採用端對端加密，您的帳戶僅儲存在本機裝置上。與 Anthropic 無關聯。',
        whatsNew: '更新日誌',
    ...
    errors: {
        ...
        voiceConversationLimitReached: '您本月已達到語音對話的最大次數。我們未來可能會新增按需語音使用功能——如果您遇到此限制，請在 github.com/juitem/jappy/issues 提交 issue。',
    ...
    server: {
        ...
        notValidHappyServer: '不是有效的 Jappy 伺服器',
        changeServer: '更改伺服器',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Jappy 工作階段 ID 已複製到剪貼簿',
        failedToCopySessionId: '複製 Jappy 工作階段 ID 失敗',
        happySessionId: 'Jappy 工作階段 ID',
    ...
    settingsVoice: {
        ...
        bypassToken: '直接連線',
        bypassTokenSubtitle: '跳過 Jappy 伺服器，直接連線到 ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: '有終端正在請求連線到您的 Jappy Coder 帳戶。這將允許終端安全地傳送和接收訊息。',
